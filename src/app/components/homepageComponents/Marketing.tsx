...
import smm from "/public/assets/smm.png";
import load from "/public/assets/loading.png";
import automation from "/public/assets/automation.png";
          ...
          <div className="row">
            ...
            <div className="col-lg-7">
              ...
              >
                ...
                <Link href="/">
                  <p className="simple" style={{ color: "#260058" }}>
                    Learn More <i className="fa-solid fa-arrow-right-long"></i>
                  </p>
                </Link>
                ...
                <div className="row align-items-center">
                  ...
                  <div className="col-lg-6">
                    <div className="smm-img">
                      <Image className="img-fluid w-100" src={smm} alt="pic" />
                    </div>
                  </div>
                </div>
              </div>
